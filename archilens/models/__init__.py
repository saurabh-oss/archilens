...
class FlowStep(BaseModel):
    ...
    data: Optional[str] = None  # What data is exchanged
    is_async: bool = False
    condition: Optional[str] = None  # Guard condition (if/else branch)
...
class ProcessFlow(BaseModel):
    ...
    entry_point: Optional[str] = None  # File path of the entry point
